...
export const NetFlixSeries = () => {
  return (
    <div style={{ textAlign: "center", fontSize: "20px" ,marginBottom:"10px",marginTop:"5px"}} >
      ...
      <p>
        <strong style={{color:"green",fontSize:"30px"}}>Name:</strong>Queen of tears
      </p>
      <p>
        <strong style={{color:"green",fontSize:"30px"}}>Rating:</strong>8.9
      </p>
      <p style={{ width: "600px", margin: "auto" }}>
        <strong style={{color:"green",fontSize:"30px"}}>Summary:</strong> Queen of Tears (Korean: 눈물의 여왕) is a 2024
